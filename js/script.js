...
// Cufon
Cufon.replace('.menu_nav ul li a, .content .mainbar .post_content a.rm, h2, h3, h4, h5, h6', { hover: true });
Cufon.replace('h1', { color: '-linear-gradient(#686e78, #2f3237)', hover: true});
